...
import RemoveTranslation from "./RemoveTranslation";
    ...
    <EditTranslation translation={translation}>
      ...
      >
        <div className="gap-4 flex-1">
          ...
          {typeof translation.value[defaultLanguage] === "string" ? (
            ...
            <p className="text-[12px] text-danger">
              ...
              <span className="ml-2">Default Language isn't assigned!</span>
            </p>
          )}
        </div>
        <div className="flex items-center gap-4">
          ...
          <RemoveTranslation translation={translation}>
            <div className="text-white hover:text-danger px-1">
